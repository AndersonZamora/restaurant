...
interface Props {
    handleRegistro: (model: IEntrada) => void
    handleVisible: () => void;
    visible: boolean;
}

export const DialogEntrada: FC<Props> = ({ handleRegistro, handleVisible, visible }) => {

    const { register, handleSubmit, formState: { errors }, reset } = useForm<IEntrada>();
